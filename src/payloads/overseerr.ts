 ...
 */
export const mediaApprovedPayload = async (
 ...
 */
export const mediaAutoApprovedPayload = async (
  data: Models.RequestProperties,
  profile: string,
): Promise<NotificationPayload> => {
  const body1 = data.subject;
 ...
 */
export const mediaAvailablePayload = async (
  data: Models.RequestProperties,
  profile: string,
): Promise<NotificationPayload> => {
  const body1 = data.subject;
 ...
 */
export const mediaDeclinedPayload = async (
  data: Models.RequestProperties,
  profile: string,
): Promise<NotificationPayload> => {
  const body1 = data.subject;
 ...
 */
export const mediaFailedPayload = async (
  data: Models.RequestProperties,
  profile: string,
): Promise<NotificationPayload> => {
  const body1 = data.subject;
 ...
 */
export const mediaPendingPayload = async (
  data: Models.RequestProperties,
  profile: string,
): Promise<NotificationPayload> => {
  const body1 = data.subject;
