...
const createTitle = (profile: string, body: string): string =>
  Payloads.title('Tautulli', profile, body);
const moduleKey = 'tautulli';

/**
 * Construct a Payloads.Notification based on a buffer warning event.
 */
...
/**
 * Construct a Payloads.Notification based on a playback error event.
 */
...
/**
 * Construct a Payloads.Notification based on a playback pause event.
 */
...
/**
 * Construct a Payloads.Notification based on a playback resume event.
 */
...
/**
 * Construct a Payloads.Notification based on a playback start event.
 */
...
/**
 * Construct a Payloads.Notification based on a playback stop event.
 */
...
/**
 * Construct a Payloads.Notification based on a plex remote access back up event.
 */
...
/**
 * Construct a Payloads.Notification based on a plex remote access down event.
 */
...
/**
 * Construct a Payloads.Notification based on a plex server back up event.
 */
...
/**
 * Construct a Payloads.Notification based on a plex server down event.
 */
...
/**
 * Construct a Payloads.Notification based on a plex update available event.
 */
...
/**
 * Construct a Payloads.Notification based on a recently added event.
 */
...
/**
 * Construct a Payloads.Notification based on a tautulli database corruption event.
 */
...
/**
 * Construct a Payloads.Notification based on a tautulli update available event.
 */
...
/**
 * Construct a Payloads.Notification based on a transcode decision change event.
 */
...
/**
 * Construct a Payloads.Notification based on a user concurrent streams event.
 */
...
/**
 * Construct a Payloads.Notification based on a watched event.
 */
